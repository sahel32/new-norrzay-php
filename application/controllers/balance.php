...
class Balance extends CI_Controller
{
    ...
    public function load_accounts($type)
    {
        ...
        if ($type == "stock") {
            ...
            <span
                class="help-inline"><?php echo (form_error('id')) ? form_error('id') : "<span class='red'>*</span>"; ?></span>
            <?php
    ...
    public function benefit()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->template("balance/benefit");
        } else {
            $data['money_type'] = $this->cash_model->group_by(array(),'type');
            $data['transaction_type'] = $this->cash_model->group_by(array(),'transaction_type');
            $data['dalar'] = '';
            $data['af'] = '';
            $data['ir'] = '';
            $data['eur'] = '';
            ...
            $this->load->template('balance/benefit_result', $data);
        }
    }
