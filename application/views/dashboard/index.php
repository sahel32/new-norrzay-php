<div id="page-inner">
    <div class="row">
        <div class="col-md-12">
            <h2>مدیریت سیستم</h2>
            <h5>از این قسمت میتوانید به تمام بخش های سیستم دسترسی داشته باشید.</h5>
    ...
    <div class="row">
        <div class="col-md-4 col-sm-8 col-xs-12 ">
            <div class="panel ">
                <div class="main-temp-back stock">
        ...
        <!-- <div class="col-md-3 col-sm-6 col-xs-12 "> 
            <div class="panel ">
                <div class="main-temp-back safebox">
                    <div class="panel-body">
                        <div class="row">
                            <a href="<?php  echo site_url('stock/lists');?>" class="fix-color">
        ...
        <div class="col-md-4 col-sm-8 col-xs-12 ">
            <div class="panel ">
                <div class="main-temp-back sells">
                    <div class="panel-body">
                        <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 ">
            <div class="panel ">
                <div class="main-temp-back reports">
                    <div class="panel-body">
                        <div class="row">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 ">
            <div class="panel ">
                <div class="main-temp-back accounts">
                    <div class="panel-body">
                        <div class="row">
        ...
        <!-- <div class="col-md-4 col-sm-6 col-xs-12 "> 
            <div class="panel ">
                <div class="main-temp-back credits">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-6"> <i><img src="<?php echo asset_url('../assets/img/credits.png'); ?>" alt="User"/></i></div>
                            <div class="col-xs-6">
                                <div class="text-temp"> دریافت ها </div>
                            </div>
                        </div>
                    </div>
                </div>
