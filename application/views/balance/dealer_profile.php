...
<div id="page-inner">
    <div class="row">
        <div class="col-md-12">
            <h2>بردگی و رسیدگی کمیشن کارها</h2>
            <h5>در این قسمت شما میتوانید تمام اطلاعات مربوط به بردگی و رسیدگی کمیشن کار مورد نظر را مشاهده کنید.</h5>
        </div>
    </div>
    <!-- /. ROW  -->
    <hr />
