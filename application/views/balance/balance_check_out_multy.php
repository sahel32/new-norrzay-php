                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                foreach ($multy_balance_rows as $key => $value) {?>
                                <form role="form" action="<?php echo site_url('balance/balance_check_out_multy/'.$id.'/'.$value->type ); ?>" method="post">
