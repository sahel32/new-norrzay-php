...
class shamci_date extends CI_Model {

    function get_today_date(){
        $day_number = $this->jdate('j');
        $month_number =  $this->jdate('n');
        $year_number =  $this->jdate('Y');

        $day_name =  $this->jdate('l');
    ...
    function get_today_datetime(){
        ...
        $second=$this->jdate('s');
        $day_name =  $this->jdate('l');
        return $year_number.'/'.$month_number.'/'.$day_number." ".$hour.":".$minute.":".$second;
    }
